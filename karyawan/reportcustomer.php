                            ...
                            <div class="panel-heading">
                                <form role="form" action="con/filtercustomer.php" method="post">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <label>Kurir</label>
                                            <input class="form-control" type="text" name="pembelian" value="<?php if($pembelian != ''){echo $pembelian; } ?>" placeholder="Filter kurir...">
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                ...
                                <div class="panel-body">
                                    <div class="table-responsive">
                                        <table class="table table-hover" id="hasil">
                                            ...
                                            <tbody>
                                                <?php
                                                    ...
                                                    if ($tglawal != '' && $tglakhir != ''){
                                                        $awal= $_GET['tglawal'];
                                                        $akhir= $_GET['tglakhir'];
                                                        $query3 = mysqli_query($koneksi, "SELECT * FROM customer where tgl between '$awal' and '$akhir'");
                                                        if ($customer != '' && $tglawal != '' && $tglakhir != ''){
                                                            $query3 = mysqli_query($koneksi, "SELECT * FROM customer where tgl between '$awal' and '$akhir' and nama like '%$customer%'");
                                                        }else
                                                        if ($pembelian != '' ){
                                                            $query3 = mysqli_query($koneksi, "SELECT * FROM customer where tgl between '$awal' and '$akhir' and kurir = '$pembelian'");
                                                        }else
                                                        if ($admin != '' ){
                                                            $query3 = mysqli_query($koneksi, "SELECT * FROM customer where tgl between '$awal' and '$akhir' and admin = '$admin'");
                                                        }
                                                    ...
                                                    if ($tglawal != '' && $tglakhir != ''){
                                                        ...
                                                        if ($customer != '' && $tglawal != '' && $tglakhir != ''){
                                                            $query2 = mysqli_query($koneksi, "SELECT * FROM customer where tgl between '$awal' and '$akhir' and nama like '%$customer%' order by  id_custoner desc limit $halaman_awal, $batas");
                                                        }else
                                                        if ($pembelian != '' ){
                                                            $query2 = mysqli_query($koneksi, "SELECT * FROM customer where tgl between '$awal' and '$akhir' and kurir = '$pembelian' order by  id_custoner desc limit $halaman_awal, $batas");
                                                        }else
                                                        if ($admin != '' ){
                                			...
                                			Ditemukan sebanyak <b><?php echo $jumlah_data ?></b> data.
                                        <nav>
                                			<ul class="pagination justify-content-center">
                                				<li class="page-item">
                                					<a class="page-link" <?php if($halaman > 1){ echo "href='?halaman=$previous#hasil'"; } ?>>Previous</a>
                                				</li>
                                				<?php
                                				if($_GET['halaman'] != ''){
                                				$hawal = $_GET['halaman'];
                                				...
                                				for ($x=$hawal;$x<=$hakhir;$x++)
                                				{
                                    				if($x != $halaman_aktif){
                                    					?> 
                                    					<li class="page-item"><a class="page-link" href="?halaman=<?php echo $x ?>#hasil"><?php echo $x; ?></a></li>
                                    					<?php
                                    				}else{
                                    				    ?>
                                    				    <li class="page-item active"><a class="page-link" href="?halaman=<?php echo $x ?>#hasil"><?php echo $x; ?></a></li>
                                    				<?php
                                    				}
                                				}
                                				?>
                                				...
                                				<li class="page-item">
                                					<a  class="page-link" href="?halaman=<?php echo $total_halaman ?>#hasil" ><?php echo $total_halaman ?></a>
                                				</li>
                                				<li class="page-item">
                                					<a  class="page-link" <?php  echo "href='?halaman=$next#hasil'";  ?>>Next</a>
                                				</li>
                                			</ul>
                                		</nav>
                                    </div>
